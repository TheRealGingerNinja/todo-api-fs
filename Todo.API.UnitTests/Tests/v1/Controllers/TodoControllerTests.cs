...
namespace Todo.API.UnitTests.v1.Controllers
{
    public class TodoControllerTests
    {
        private const string MOCK_TOKEN_SIG = "rNZQndjf1Bf-11c9A7qELIKEiDPTTFBonflNgBN-cCk";

        private static string MOCK_USER_99_TOKEN = $"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InRlc3RAdGVzdC5jb20iLCJuYW1laWQiOiI5OSIsImp0aSI6IjRkNmI4MTEwLTMxODYtNDc3ZC1iMDc5LTVlOWIzMGJkNjNkOCIsInJvbGUiOiJVc2VyIiwiZXhwIjoxNjA1OTY1MDA2fQ.{MOCK_TOKEN_SIG}";
        ...
        private static string MOCK_USER_98_TOKEN = $"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InRlc3RAdGVzdC5jb20iLCJuYW1laWQiOiI5OCIsImp0aSI6IjRkNmI4MTEwLTMxODYtNDc3ZC1iMDc5LTVlOWIzMGJkNjNkOCIsInJvbGUiOiJVc2VyIiwiZXhwIjoxNjA1OTY1MDA2fQ.{MOCK_TOKEN_SIG}";
