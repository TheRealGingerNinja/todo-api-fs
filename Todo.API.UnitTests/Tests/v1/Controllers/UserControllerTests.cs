...
namespace Todo.API.UnitTests.v1.Controllers
{
    public class UserControllerTests
    {
        ...
        private static string MOCK_ADMIN_TOKEN = $"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InRlc3RAdGVzdC5jb20iLCJuYW1laWQiOiI5OSIsImp0aSI6IjRkNmI4MTEwLTMxODYtNDc3ZC1iMDc5LTVlOWIzMGJkNjNkOCIsInJvbGUiOiJBZG1pbiIsImV4cCI6MTYwNTk2NTAwNn0.{MOCK_TOKEN_SIG}";
